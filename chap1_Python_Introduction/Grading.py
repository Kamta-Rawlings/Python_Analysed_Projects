...
if grade > 70:
    if grade > 90:
        ...
        print(f'Your grade of {grade} earns you an B in this course')
elif grade > 50:
    print(f'Your grade of {grade} earns you an C in this course')
else:
    print(f'Your grade of {grade} earns you an D in this course')

'''
I think you can use if 4 times to print
out thesame result but this looks and professionl
The challenge here was using if and elif to have the desired results
'''
